                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center py-5 mt-6">
                            ...
                            <p class="lead mb-5  ">Simple mvc website about Genshin Impact database</p>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-dark btn-lg px-4 me-sm-3" target="blank" href="https://github.com/Kazut00/">Github</a>
...
<section class="welcome">
        <div class="container  "> 
                ...
                <div class="col-md-2"></div>
                    ...
                    <p class="mt-3 ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus at placerat ante. Praesent nulla nunc,  pretium dapibus efficitur in, auctor eget elit. Lorem ipsum dolor sit amet</p>
                </div>
                <div class="col-md-2"></div>
                </div>
        </div>
            ...
            <div class="container px-4 py-1 ">
                ...
                <div class="row gx-5 mt-6">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="text-center">Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.
        ...
        <section class="bg-light py-5 border-bottom">
            <div class="container px-5 my-5">
                <div class="text-center mb-5">
                    ...
                    <p class="lead mb-0">More Character </p>
                </div>
                <div class="row gx-5 justify-content-center">
                    <!-- Pricing card free-->
                                ...
                                <div class="col-md-5">
                                    <div class="profile-card-6"><img src="<?= BASEURL ?>/img/card/Character_Eula_Card.png" class="img img-responsive">
                                        <div class="profile-name">Eula</div>
                                        <div class="profile-position">Lorem Ipsum Donor</div>
                                        <div class="profile-overview">
                                            <div class="profile-overview">
                                                <div class="row text-center">
